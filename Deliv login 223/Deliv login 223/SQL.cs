...
{ 
    class SQL
    {
        ...
        public static SqlConnection con = new SqlConnection(@"Data Source=localhost\SQLEXPRESS;Database=Deliverable3;Integrated Security=True");
        ...
        public static void executeQuery(string query)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("An error has occured, data not inputted appropriately");
                return;
            }
        }
